...
function changeStatus(lead, newStatus) {
    router.patch(`/admin/sales/leads/${lead.id}`, { status: newStatus }, { preserveScroll: true });
}
    ...
    <AdminLayout>
        ...
        <div @click="closeDropdowns">
            ...
            <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                    ...
                    <table class="w-full">
                        <thead class="bg-gray-50 border-b border-gray-200">
                            <tr>
                                ...
                                <th class="text-left px-6 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Telefono</th>
                                <th class="text-left px-6 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Presupuesto</th>
                                ...
                                <th class="text-left px-6 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Asesor</th>
                                <th class="text-left px-6 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Ultimo contacto</th>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <tr v-for="lead in leads.data" :key="lead.id" class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <p v-if="lead.company" class="text-gray-400 text-xs truncate">{{ lead.company }}</p>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-600">
                                    <span v-if="lead.event" class="truncate block max-w-32">{{ lead.event.name }}</span>
                ...
                <!-- Pagination -->
                <div v-if="leads.last_page > 1" class="border-t border-gray-200 px-6 py-4 flex items-center justify-between">

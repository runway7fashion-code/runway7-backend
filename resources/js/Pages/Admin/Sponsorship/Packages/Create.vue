...
function submit() {
    form.post('/admin/sponsorship/packages');
}
</script>
    ...
    <AdminLayout>
        <template #header>
            <div class="flex items-center space-x-2 text-sm">
                ...
                <span class="text-gray-700 font-medium">New Package</span>
            </div>
        </template>

        <div class="max-w-2xl">
            <h3 class="text-2xl font-bold text-gray-900 mb-6">New Package</h3>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-6">
                    ...
                    <p v-if="!benefits.length" class="text-sm text-gray-400">No benefits available. Create them first.</p>
                </div>

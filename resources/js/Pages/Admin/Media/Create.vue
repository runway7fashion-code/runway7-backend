    ...
    <AdminLayout>
        <template #header>
            <div class="flex items-center gap-2">
                ...
                <h2 class="text-lg font-semibold text-gray-900">Create Media</h2>
            </div>
        </template>
            ...
            <form @submit.prevent="submit" class="bg-white rounded-2xl border border-gray-200 p-6 space-y-5">
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <select v-model="form.event_id" class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-black/10">
                ...
                <div class="flex gap-3 pt-4">
                    <Link href="/admin/operations/media" class="flex-1 py-2.5 border border-gray-200 rounded-xl text-sm font-semibold text-gray-700 text-center hover:bg-gray-50">Cancel</Link>
                    <button type="submit" :disabled="form.processing" class="flex-1 py-2.5 bg-black text-white rounded-xl text-sm font-semibold hover:bg-gray-800 disabled:opacity-40">
                        {{ form.processing ? 'Creating...' : 'Create Media' }}
                    </button>
                </div>
            </form>
        </div>

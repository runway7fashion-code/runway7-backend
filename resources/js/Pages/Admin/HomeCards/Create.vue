...
function submit() {
    form.post('/admin/operations/home-cards', {
        forceFormData: true,
    });
}
</script>
        ...
        <div class="max-w-2xl mx-auto">
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="bg-white rounded-2xl border border-gray-200 p-6">
                    ...
                    <div class="aspect-[4/3] rounded-xl overflow-hidden border-2 border-dashed border-gray-300 bg-gray-50 mb-3 relative">
                        ...
                        <div v-else class="w-full h-full flex flex-col items-center justify-center text-gray-300">
                            ...
                            <p class="text-sm">Recommended ratio: 4:3</p>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input v-model="form.title" type="text" placeholder="e.g. GET TICKETS"
                ...
                <div class="bg-white rounded-2xl border border-gray-200 p-6">
                    ...
                    <p class="text-xs text-gray-400 mb-4">If none selected, the card will be shown to all roles.</p>

...
<head>
    ...
    <title>Welcome to Runway 7 — Media Credentials</title>
    <style>
...
<div class="email-card">
    ...
    <div class="body">
        ...
        <p class="text">
            Welcome to the <strong>Runway 7 Fashion</strong> media team!
            You have been approved for media coverage. Below you will find your event details and access credentials.
        </p>
        ...
        <div class="info-box">
            ...
            <div class="info-row">
                <span class="info-label">{{ $day['label'] }}</span>
                <span class="info-value">{{ $day['date'] ? \Carbon\Carbon::parse($day['date'])->format('l, F j, Y') : '—' }}</span>
            </div>
            @endforeach
        </div>
        @endforeach
        ...
        <table class="credentials-table" cellpadding="0" cellspacing="0" border="0">
            <tr>
                ...
                <td style="background-color:#f7f7f7; font-weight:700; color:#111111; padding:14px 20px;">{{ $media->email }}</td>
            </tr>
            <tr>
        ...
        <p class="text">Download the app to access your media pass, event schedule and upload your content after the event.</p>

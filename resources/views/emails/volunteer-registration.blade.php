...
<head>
    ...
    <title>Thank You for Applying — Runway 7 Volunteers</title>
    <style>
...
<div class="email-card">
    ...
    <!-- Body -->
    <div class="body">
        <p class="greeting">Hi, {{ $volunteer->first_name }}! 👋</p>

        <p class="text">
            Thank you for applying to volunteer with <strong>Runway7 Fashion</strong>!
        ...
        <div class="steps-box">
            ...
            <div class="step">&#8226; Our team will review your application and availability.</div>
            <div class="step">&#8226; If selected, you will receive a confirmation email with your assignment details and schedule.</div>
            <div class="step">&#8226; You will be provided with your official Runway 7 volunteer T-shirt at the event.</div>
        </div>

        <p class="text">
            Please note that due to the high volume of applications, the review process may take a few days.
            We appreciate your patience and enthusiasm for being part of the Runway 7 team!
        </p>
    ...
    <div class="footer">
        ...
        <div class="footer-text">
            ...
            &copy; {{ date('Y') }} Runway7 Fashion. All rights reserved.
        </div>
    </div>
